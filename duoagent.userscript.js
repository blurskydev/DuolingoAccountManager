...
container.style.backdropFilter = 'blur(40px)'; // Increase blur effect
...
disIcon.style.width = '20px'; // Adjust size as needed
disIcon.style.height = '20px'; // Adjust size as needed
disIcon.style.verticalAlign = 'middle'; // Align icon vertically with text
disIcon.style.marginRight = '8px'; // Space between icon and text
